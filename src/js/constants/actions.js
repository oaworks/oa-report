...
const ACTION_ARTICLE_LINK_CLASSES = "inline-flex items-center rounded-full border border-neutral-300 bg-neutral-100 px-2 py-0.5 text-xs text-neutral-900 whitespace-nowrap outline outline-1 outline-transparent transition-colors hover:bg-neutral-200";
const ACTION_TABLE_CELL_CLASSES = "border-b border-neutral-200 bg-white px-3 py-2 text-sm align-top break-words";
const ACTION_TABLE_OPTIONAL_CELL_CLASSES = "hidden border-b border-neutral-200 bg-white px-3 py-2 text-sm align-top break-words sm:table-cell";
const ACTION_TABLE_CENTER_CELL_CLASSES = "border-b border-neutral-200 bg-white px-3 py-2 text-sm text-center align-top break-words";
const ACTION_TABLE_OPTIONAL_CENTER_CELL_CLASSES = "hidden border-b border-neutral-200 bg-white px-3 py-2 text-sm text-center align-top break-words sm:table-cell";
const ACTION_TABLE_PRIMARY_TEXT_CLASSES = "text-neutral-900";
const ACTION_TABLE_SECONDARY_TEXT_CLASSES = "text-neutral-600";
const ACTION_TABLE_DRAFT_BUTTON_CLASSES = "inline-flex items-center rounded-full border border-carnation-500 bg-carnation-500 p-2 text-white shadow-sm transition duration-200 hover:bg-carnation-600 focus-visible:ring-offset-white";
...
export const ACTION_TABLE_CONFIGS = [
  ...
  },
  {
    ...
    rowTemplate: `<td class='${ACTION_TABLE_CELL_CLASSES}' data-doi='\${action.DOI}' data-in-epmc='\${action.has_epmc_fulltext}' data-epmc-licence='\${action.epmc_licence}'>\
      ...
      <td class='border-b border-neutral-200 bg-white px-3 py-2 text-sm text-left text-neutral-900 align-top break-words'>\
