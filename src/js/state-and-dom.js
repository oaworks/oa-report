...
export const yearButtons = document.querySelectorAll(".js_year_select");

// Strategy buttons
export const strategyTabBtns = document.querySelectorAll(".js_strategy_btn");