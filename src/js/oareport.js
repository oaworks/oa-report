...
oareport = function(org) {
  ...
  axios.get(report).then(function (response) {
    ...
    getExportLink = function() {
      ...
      xhr.onload = function () {
        document.querySelector("#csv_email_msg").innerHTML = "OA.Report has started building your CSV export at <a href='" + this.response + "' target='_blank' class='underline' id="exportLink">this URL</a>. Please check your email to get the full data once it’s ready.";
      };
      xhr.send();
