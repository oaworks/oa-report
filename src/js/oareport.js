...
oareport = function(ROR) {
  console.log("test: " + ROR);
  const articles = axios.get(base + "articles/count?q=author_affiliations:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20OR%20funder_names:%22Bill%20and%20Melinda%20Gates%20Foundation%22"),
    oaArticles = axios.get(base + "articles/count?q=author_affiliations:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20OR%20funder_names:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20AND%20is_oa:true"),
    canArchive = axios.get(base + "articles?sort=published:desc&q=author_affiliations:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20OR%20funder_names:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20AND%20is_oa:%20false%20AND%20can_archive:true"),
    archivingChamps = axios.get(base + "articles/terms/author_names?q=author_affiliations:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20OR%20funder_names:%22Bill%20and%20Melinda%20Gates%20Foundation%22%20%20AND%20has_repository_copy:%22true%22%20AND%20oa_status:%22green%22");
  ...
  let ROR = (window.location.pathname);
  oareport(ROR);
