const publisherDataAlltime = {
  "query": {
    "bool": {
      "must": [
        {
          "term": {
            "orgs.keyword": "Bill & Melinda Gates Foundation"
          }
        },
        {
          "bool": {
    ...
    "all": {
      ...
      "aggs": {
        "articles_published": {
          "filter": {
            "exists": {
              "field": "supplements.grantid__bmgf.keyword"
            }
          }
        }
      }
