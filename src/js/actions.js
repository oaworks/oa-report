...
const ACTIVE_ACTION_BADGE_CLASSES = ["bg-white", "text-neutral-900"];
const INACTIVE_ACTION_BADGE_CLASSES = ["border", "border-neutral-300", "bg-neutral-100", "text-neutral-700", "group-hover:bg-neutral-200"];
